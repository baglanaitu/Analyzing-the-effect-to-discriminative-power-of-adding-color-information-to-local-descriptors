...
I2 = imrotate(imresize(imread('./images/kettle_2.jpg'),0.5),0);

tic
% Color offset 
sigma = 0.1;
k = 1; % range [1 4]
alpha = 0.1; %range: [0.4 0.6]
...
[features1,valid_points1] = extractFeatures(rgb2gray(I1), corners1);
[features2,valid_points2] = extractFeatures(rgb2gray(I2), corners2);
toc
...
title(['ORB + proposed method, Inliers: ' num2str(sum(inliersIndex))])
% Plot keypoints
%{
